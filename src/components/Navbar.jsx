    ...
    <>
      <nav className="bg-white dark:bg-neutral-950 shadow fixed w-full z-10">
        <div className="container mx-auto flex justify-between items-center p-3 lg:px-14">
          ...
          {/* Nav-menu */}
          <ul
            className={`flex gap-x-5 order-2 absolute top-full left-0 flex-col bg-white dark:bg-neutral-950 w-full sm:w-auto border-t-1 border-neutral-200 dark:border-neutral-800 -translate-x-full sm:translate-0 ${
          ...
          >
            <li className="relative text-gray-800 dark:text-white px-3 sm:px-0 hover:bg-neutral-200 dark:hover:bg-neutral-900 sm:hover:bg-transparent sm:dark:hover:bg-transparent">
              <Link
                ...
                smooth={true}
                duration={500}
                className="py-3 block font-bold sm:font-semibold before:content=[''] before:absolute before:left-0 before:bottom-0 before:bg-cyan-500 before:w-0 before:h-0.5 before:transition-all before:duration-300 hover:before:w-full cursor-pointer"
              >
                Home
              </Link>
            </li>
      ...
      {isVisibleScrollBtn && (
        <div className="z-10 fixed bottom-7 right-5">
          <Link
            ...
            smooth={true}
            duration={500}
            className="cursor-pointer mb-3 rounded-full w-12 h-12 dark:bg-white bg-neutral-900 text-white dark:text-neutral-900 flex justify-center items-center text-3xl"
          >
          ...
          <a
            ...
            target="_blank"
            className="cursor-pointer rounded-full w-12 h-12 bg-green-400 text-white flex justify-center items-center text-3xl"
          >
            <FaWhatsapp />
          </a>
        </div>
